              ...
              {loading ? (
                ...
                filteredProducts.map((prod) => (
                  <tr key={prod.cod_producto_proveedor || prod.cod_producto}>
                    ...
                    <td style={{ fontWeight: 700, color: (prod.stock_disponible || 0) <= 5 ? '#ef4444' : '#38bdf8' }}>
                    ...
                    <td>
                      <button
                        ...
                        className="tt-btn tt-btn--secondary"
                        style={{ padding: '0.25rem 0.55rem', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.3rem', color: '#38bdf8', borderColor: '#0284c7' }}
