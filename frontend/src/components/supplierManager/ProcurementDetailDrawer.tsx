      ...
      <div className="ops-drawer-panel" onClick={(e) => e.stopPropagation()}>
        <div className="ops-drawer-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <FileText size={20} color="var(--tt-color-primary)" />
        ...
        <div className="ops-drawer-body">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            ...
            <div style={{ background: 'var(--tt-color-text-main)', padding: '1rem', borderRadius: '0.75rem', border: '1px solid var(--tt-color-surface-subtle)' }}>
              <span style={{ fontSize: '0.85rem', color: 'var(--tt-color-text-light)' }}>Prioridad Asignada</span>
              <div style={{ fontSize: '1.4rem', fontWeight: 700, color: 'var(--tt-color-warning)', marginTop: '0.25rem' }}>
                {order.prioridad || 'NORMAL'}
              </div>
            </div>
          </div>

          <div style={{ background: 'var(--tt-color-text-main)', padding: '1rem', borderRadius: '0.75rem', border: '1px solid var(--tt-color-surface-subtle)', display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              <Calendar size={17} color="var(--tt-color-text-light)" />
              <span style={{ fontSize: '0.85rem', color: 'var(--tt-color-text-muted)' }}>
