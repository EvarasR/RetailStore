...
urlpatterns = [
    ...
    path("api/facturas/<int:cod_factura>/", views.api_factura_detalle, name="api_factura_detalle"),
    path("api/facturas/<int:cod_factura>/pdf/", views.api_factura_pdf, name="api_factura_pdf"),
    path("api/facturas/<int:cod_factura>/reenviar/", views.api_reenviar_factura, name="api_reenviar_factura"),
    ...
    path("api/preferencias-notificacion/", views.api_preferencias_notificacion, name="api_preferencias_notificacion"),
