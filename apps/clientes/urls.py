...
urlpatterns = [
    ...
    path("api/productos/ofertas/", views.api_productos_ofertas, name="api_productos_ofertas"),
    path("api/productos/autocompletar/", views.api_productos_autocompletar, name="api_productos_autocompletar"),
